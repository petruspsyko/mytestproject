...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/petrusisaksson/Desktop/my project/handedness_lastrun.py',
...
text_1 = visual.TextStim(win=win, name='text_1',
    text='Hej! Här kommer du snart få svara på några frågor om handdominans. \n\nDu kan trycka på valfri tangent för att fortsätta.',
    font='Arial',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='Ange vilken hand du föredrar att använda för var och en av aktiviteterna du kommer se genom att trycka på tangenterna \nV (för vänster hand) eller H (för höger hand) på tangentbordet. ',
    font='Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
text_3 = visual.TextStim(win=win, name='text_3',
    text='I de fall där du har en stark preferens för att använda den ena handen framför den andra, så till den grad att du aldrig skulle använda \nden andra handen om du inte absolut måste, tryck på PIL VÄNSTER, för vänster hand, och PIL HÖGER, om det gäller höger hand.',
    font='Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
text_4 = visual.TextStim(win=win, name='text_4',
    text='I de fall där det inte spelar någon roll vilken hand du använder, tryck på mellanslag.\n\nVissa av aktiviteterna förutsätter användning av båda händerna. I dessa fall är de delar av \naktiviteten eller föremålet för vilka handdominansen efterfrågas angivna inom parentes.\n\nTryck på valfri tangent för att börja.',
    font='Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
text = visual.TextStim(win=win, name='text',
    text='Tack för dina svar! \n\nDu kan säga till experimentledaren att du är färdig.',
    font='Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
while continueRoutine:
    ...
    # *key_resp_1* updates
    waitOnFlip = False
    if key_resp_1.status == NOT_STARTED and tThisFlip >= 1-frameTolerance:
        # keep track of start time/frame for later
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
instruktion2Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "instruktion2"-------
while continueRoutine:
    # get current time
    t = instruktion2Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=instruktion2Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
intruktion3Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "intruktion3"-------
while continueRoutine:
    # get current time
    t = intruktion3Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=intruktion3Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
_key_resp_4_allKeys = []
# keep track of which components have finished
instruktion4Components = [text_4, key_resp_4]
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
instruktion4Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "instruktion4"-------
while continueRoutine:
    # get current time
    t = instruktion4Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=instruktion4Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
for thisTrial in trials:
    ...
    _key_resp_allKeys = []
    # keep track of which components have finished
    trialComponents = [trial_text, key_resp]
    ...
    while continueRoutine:
        ...
        if key_resp.status == STARTED and not waitOnFlip:
            theseKeys = key_resp.getKeys(keyList=['v', 'h', 'left', 'right', 'space'], waitRelease=False)
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
tackClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1
...
while continueRoutine and routineTimer.getTime() > 0:
    # get current time
    t = tackClock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=tackClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
